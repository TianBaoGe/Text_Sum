...
tf.app.flags.DEFINE_string("data_dir", "/home/tianbao/TensorFlow-Summarization-master/data", "Data directory")
tf.app.flags.DEFINE_string("test_file", "/home/tianbao/TensorFlow-Summarization-master/data/test.article.txt", "Test filename.")
tf.app.flags.DEFINE_string("test_output", "/home/tianbao/TensorFlow-Summarization-master/output/output.txt", "Test output.")
tf.app.flags.DEFINE_string("train_dir", "/home/tianbao/TensorFlow-Summarization-master/model", "Training directory.")
tf.app.flags.DEFINE_string("tfboard", "/home/tianbao/TensorFlow-Summarization-master/tfboard", "Tensorboard log directory.")
tf.app.flags.DEFINE_boolean("decode", True, "Set to True for testing.")
...
tf.app.flags.DEFINE_integer(
    "max_iter", 10, "Maximum training iterations.")
tf.app.flags.DEFINE_integer(
    "steps_per_validation", 2, "Training steps between validations.")
tf.app.flags.DEFINE_integer(
    "steps_per_checkpoint", 2, "Training steps between checkpoints.")
tf.app.flags.DEFINE_string(
    "checkpoint", "", "Checkpoint to load (use up-to-date if not set)")

FLAGS = tf.app.flags.FLAGS
#
#定义桶，因为摘要长度不是相同的，为了更好的训练效果和更加方便的工程处理，所以定义了不同长度的桶，不同数据类似放在一起
